...
- **Home feed** — лента новых серий (`KodikEpisodeRelease`) с infinite scroll, фильтром статуса (всё / онгоинги / вышедшие) и скрытием тайтлов без рейтинга (вкл. по умолчанию)
...
- **Search** — поиск по локальной БД Kodik с неточными совпадениями по названию, сортировкой по релевантности или дате выхода, адаптивными полноширинными карточками результатов и настраиваемой задержкой подсказок в шапке
