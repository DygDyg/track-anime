...
- **Site settings** — настройки внешнего вида, часов, ленты, плеера, локального ТВ-режима и украшений аватарок для авторизованных; общая страница `/application` и вкладка настроек для загрузки Android APK по кнопке или QR-коду и версии из манифеста релиза; админская ротация WEBP-логотипов из `public/brand-logos`; «Недавно открытые» доступны отдельной иконкой рядом с поиском; глобальная кнопка «Наверх» возвращает к началу длинных страниц
