...
- **Совместный просмотр beta-плеера** — настраиваемые в админке ephemeral WebSocket-комнаты с invite-ссылкой, списком участников, гостевыми случайными именами, передачей мастера, правами участников и админским просмотром активных комнат
