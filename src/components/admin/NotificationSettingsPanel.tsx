...
const DEFAULT_TEST_SHIKIMORI_ID_STRING = String(DEFAULT_TEST_SHIKIMORI_ID);
...
export function NotificationSettingsPanel({
  ...
  const [testShikimoriId, setTestShikimoriId] = useState(DEFAULT_TEST_SHIKIMORI_ID_STRING);
