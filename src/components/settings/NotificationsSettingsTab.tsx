...
export function NotificationsSettingsTab() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h3 className="text-sm font-semibold text-foreground">Новое в вашей истории</h3>
        <p className="mt-1 text-xs leading-relaxed text-muted">
          Уведомление при выходе новой серии в тайтле из вашей истории просмотра — в той же озвучке,
          что вы смотрели. При открытой вкладке сайт опрашивает сервер каждые 30&nbsp;с; для фона
          включите push в браузере.
        </p>
      </div>
      ...
      <div className="space-y-2">
        <p className="text-xs font-medium uppercase tracking-wide text-muted">Каналы</p>
