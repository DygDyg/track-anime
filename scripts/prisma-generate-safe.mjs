...
if (engineLocked && existsSync(clientMarker)) {
  console.warn(
    "[dev] prisma generate propushchen: query engine zanyat drugim processom " +
      "(telegram-bot, staryy dev-server). Esli menyali schema — ostanovite processy i zapustite npm run db:generate."
  );
  process.exit(0);
}
